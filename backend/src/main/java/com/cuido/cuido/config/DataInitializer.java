...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("===================================================");
        System.out.println("🌱 INICIALIZANDO DATOS DE PRUEBA PARA CUIDO");
        System.out.println("===================================================");
        ...
        if (!usuarioRepository.existsByEmail(cuidador1Email)) {
            ...
            cuidador1.setNombreCompleto("María González");
            ...
            System.out.println("✅ CUIDADOR creado: " + cuidador1Email + " / contraseña: Cuido123!");
        } else {
            cuidador1 = usuarioRepository.findByEmail(cuidador1Email).orElse(null);
            System.out.println("ℹ️  CUIDADOR 1 ya existe");
        }
        ...
        if (!usuarioRepository.existsByEmail(paciente1Email)) {
            ...
            System.out.println("✅ PACIENTE creado: " + paciente1Email + " / contraseña: Paciente123!");
        } else {
            paciente1 = usuarioRepository.findByEmail(paciente1Email).orElse(null);
            System.out.println("ℹ️  PACIENTE 1 ya existe");
        }
        ...
        if (!usuarioRepository.existsByEmail(paciente2Email)) {
            ...
            paciente2.setNombreCompleto("Ana Martínez");
            ...
            System.out.println("✅ PACIENTE creado: " + paciente2Email + " / contraseña: Paciente123!");
        } else {
            paciente2 = usuarioRepository.findByEmail(paciente2Email).orElse(null);
            System.out.println("ℹ️  PACIENTE 2 ya existe");
        }
    ...
    private void crearDatosDePrueba(Usuario cuidador, Usuario paciente) {
        ...
        if (bitacoraRepository.findByPacienteId(paciente.getId()).isEmpty()) {
            ...
            bitacora1.setTitulo("Bitácora del " + LocalDate.now().minusDays(2));
            bitacora1.setDescripcion("El paciente presentó buen estado general. Tomó todos sus medicamentos según lo prescrito. Realizó caminata de 15 minutos por el parque.");
            bitacora1.setObservaciones("Se mostró animado y con apetito normal.");
            ...
            bitacora2.setTitulo("Bitácora del " + LocalDate.now().minusDays(1));
            bitacora2.setDescripcion("Día tranquilo. El paciente descansó bien durante la noche. Presión arterial: 130/85 mmHg. Glucosa en ayunas: 110 mg/dL.");
            bitacora2.setObservaciones("Recordar control médico la próxima semana.");
            ...
            bitacora3.setTitulo("Bitácora del " + LocalDate.now());
            bitacora3.setDescripcion("El paciente se despertó temprano con buen ánimo. Desayunó normalmente. Se realizó control de signos vitales.");
            bitacora3.setObservaciones("Todo dentro de parámetros normales.");
            bitacoraRepository.save(bitacora3);

            System.out.println("✅ 3 BITÁCORAS creadas para " + paciente.getNombreCompleto());
        }
        ...
        if (citaMedicaRepository.findByPacienteId(paciente.getId()).isEmpty()) {
            ...
            cita1.setUbicacion("Hospital Italiano, Av. Pueyrredón 1234");
            cita1.setNombreDoctor("Dr. Roberto Fernández");
            cita1.setEspecialidad("Cardiología");
            cita1.setMotivo("Control mensual de presión arterial");
            ...
            cita2.setUbicacion("Clínica Santa María, Calle 50 #123");
            cita2.setNombreDoctor("Dra. Laura Gómez");
            cita2.setEspecialidad("Endocrinología");
            ...
            System.out.println("✅ 2 CITAS MÉDICAS creadas para " + paciente.getNombreCompleto());
        }
        ...
        if (medicamentoRepository.findByPacienteIdAndActivoTrue(paciente.getId()).isEmpty()) {
            ...
            metformina.setFrecuencia("Dos veces al día");
            ...
            atorva.setFrecuencia("Una vez al día");
            ...
            System.out.println("✅ 3 MEDICAMENTOS con horarios creados para " + paciente.getNombreCompleto());
        }

        System.out.println("✅ Datos de prueba creados para cuidador y paciente");
    }
}

	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						// - GET: pueden ver PACIENTE y CUIDADOR
						// - POST/PUT/DELETE: solo PACIENTE (gestiona sus contactos)
						.requestMatchers(HttpMethod.GET, "/api/contactos-emergencia/**").hasAnyRole("PACIENTE", "CUIDADOR")
						.requestMatchers(HttpMethod.POST, "/api/contactos-emergencia/**").hasRole("PACIENTE")
						.requestMatchers(HttpMethod.PUT, "/api/contactos-emergencia/**").hasRole("PACIENTE")
						.requestMatchers(HttpMethod.DELETE, "/api/contactos-emergencia/**").hasRole("PACIENTE")
						...
						.requestMatchers(HttpMethod.GET, "/api/cuidadores-pacientes/**")
						.hasAnyRole("PACIENTE", "CUIDADOR")

						// Aceptar invitación - solo cuidadores
						.requestMatchers(HttpMethod.POST, "/api/cuidadores-pacientes/{relacionId}/aceptar")
						.hasRole("CUIDADOR")

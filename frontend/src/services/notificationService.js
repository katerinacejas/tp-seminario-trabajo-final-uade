...
/**
 * Programa una notificaci�n para un medicamento
 * @param {Object} medicamento - Objeto con informaci�n del medicamento
...
export async function programarNotificacionMedicamento(medicamento) {
	try {
		...
		// Calcular el tiempo hasta la notificaci�n
		...
		console.log(` Notificaci�n programada para medicamento ${medicamento.nombre}: ID ${notificationId}`);
		return notificationId;
	} catch (error) {
		console.error('Error al programar notificaci�n de medicamento:', error);
		return null;
	}
}

/**
 * Programa una notificaci�n 1 hora antes de una cita m�dica
 * @param {Object} cita - Objeto con informaci�n de la cita
 * @param {string} cita.titulo - T�tulo de la cita
...
export async function programarNotificacionCita(cita) {
	try {
		...
		if (fechaNotificacion <= ahora) {
			console.log('La cita ya pas� o es muy pronto, no se programa notificaci�n');
			return null;
		}
		...
		console.log(` Notificaci�n programada para cita ${cita.titulo}: ID ${notificationId}`);
		return notificationId;
	} catch (error) {
		console.error('Error al programar notificaci�n de cita:', error);
		return null;
	}
}
...
/**
 * Env�a una notificaci�n inmediata (para testing)
...
export async function enviarNotificacionInmediata(titulo, cuerpo) {
	try {
		...
		console.log(' Notificaci�n enviada inmediatamente');
	} catch (error) {
